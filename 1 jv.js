...
let bienvenida = 'bienvenido a esta pagina';
...
Luego, almacena la respuesta en una variable y muestra la respuesta en la consola del navegador.*/
 let preguntaUsuario = prompt("¿Cuál es el lenguaje de programación que más te gusta?.");
 console.log("Mi programa favorito es ",preguntaUsuario);
...
Luego, verifica si es positivo, negativo o cero utilizando un if-else y muestra el mensaje correspondiente.*/
 ...
 if(num > 0 ){
    ...
    alert("el numero es ",+num,"es negativo");
}
